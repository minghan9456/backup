...
<script type="text/javascript" src="//<?=($THISHOST)?>/mjohnh/js/api.js"></script>
</head>
<body>
    ...
    FB.api('/me?fields=id,name,email,age_range,birthday', function(response) {
      ...
      document.getElementById('status').innerHTML =
        'Thanks for logging in, ' + response.name + '!';
			...
			var THISHOST = '<?=($THISHOST)?>';
			
			ajaxPost('//'+THISHOST+'/mjohnh/engMemo/login', data, null, function(rtn) {
				if (rtn.status) {
					window.location.replace('//'+THISHOST+'/mjohnh/engMemo/?member=' + response.name);
				}
				else {
					alert("login失敗");
				}
